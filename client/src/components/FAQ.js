    ...
    <div className='faq'>
        ...
        <section className='services'>
            <div className='service-right'>
                ...
                <label for="collapsible-head-2">What is the price?</label>
                ...
                <div className='qa'>
                    ...
                    <label for="collapsible-head-3">What is the price?</label>
                ...
                <div className='qa'>
                    ...
                    <label for="collapsible-head-4">What is the price?</label>
                ...
                <div className='qa'>
                    ...
                    <label for="collapsible-head-5">What is the price?</label>
                ...
                <div className='qa'>
                    ...
                    <label for="collapsible-head-6">What is the price?</label>
