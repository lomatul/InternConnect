...
const Evaluation4 = ({feedbackvalue}) => {
    return (     
    <div >
       <p>This portion contains questions to evaluate an intern.</p>
        ...
        <label htmlFor="">Overall comment about the intern<span>*</span></label>
         ...
         value={feedbackvalue.eval4_comment || ''} ></textarea>
            </div>
            ...
            <FormControl>
              ...
              <input type="text" value={feedbackvalue.eval4_liking || ''}  />
            </div>

            <div className="form-group">
              <label htmlFor="">Mention one thing you do not like about this intern<span>*</span></label>
              <input type="text" value={feedbackvalue.eval4_notliking || ''}  />
            </div>
            ...
            <div className="form-group">
             ...
             <textarea rows="10"    style={{ marginTop: "30px" }} 
             value={feedbackvalue.eval4_suggestion || ''}  ></textarea>
            </div>
